...
const SantaBody = ({ isWhipping }) => {
  ...
  return (
    <group position={[0, -1.3, 1.2]}>
      {/* Santa's belly/lower chest - just peeking at bottom */}
      ...
      {/* Left Arm - just forearm visible */}
      <group ref={leftArmRef} position={[-0.7, 0.1, -0.2]}>
        {/* Forearm */}
        ...
        {/* White cuff */}
        <mesh position={[-0.08, -0.35, -0.25]} rotation={[0.8, 0, 0.1]}>
      ...
      {/* Right Arm - just forearm visible */}
      <group ref={rightArmRef} position={[0.7, 0.1, -0.2]}>
        {/* Forearm */}
        <mesh rotation={[0.8, -0.1, -0.2]}>
          <capsuleGeometry args={[0.1, 0.45, 8, 16]} />
          <meshStandardMaterial color="#cc0000" roughness={0.8} />
